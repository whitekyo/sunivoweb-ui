    ...
    $.validationEngineLanguage = {
        newLang: function () {
            $.validationEngineLanguage.allRules = {
                ...
                "future": {//validate[custom[date],future[2010/01/01]]//validate[custom[date],future[NOW]] 
                    "regex": "none",
                    "alertText": "* 日期需在 ",
                    "alertText2": " 之前"
                },
                ...
                "phone": {
                    ...
                    "regex": /^(\d{3}-\d{7,8}|\d{4}-\d{7,8})+$/,
                    "alertText": "* 无效的电话号码如：021-88888888"
                },
                "fax": {
                    // credit:jquery.h5validate.js / orefalo
                ...
                "mobile": {
                    "regex": /^(1[1-9][0-9]|15[0|3|6|7|8|9]|18[8|9])\d{8}$/,
                    "alertText": "* 无效的手机号码"
                },
                "email": {
                	"regex":/^[a-zA-Z0-9\._-]+@[a-zA-Z0-9_-]+\.[a-zA-Z0-9_-]{2,4}$/,
                    "alertText": "* 邮件地址无效"
                },
                "emailormobile": {
                    "regex": /(^1[0-9]{10}$)|(^\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$)/,
                    "alertText": "* 请输入正确的手机号码或者Email"
                },
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
                    "alertText": "* 不是有效的整数"
 		...
 		"signlessNumber": {
                ...
                "productname": {
                    "regex": /^[a-zA-Z\u4e00-\u9fa5]+$/, //只含有汉字、数字、字母、下划线，下划线位置不限：
                    "alertText": "* 无效的产品名称<br/>* 只允许含有汉字、数字、字母、下划线."
                },
                "goodscompany": {//货代公司中文、英文、数字、小数点、空格
                    "regex": /^[a-zA-Z0-9.\s\u4e00-\u9fa5]+$/,
                    "alertText": "*中文、英文、数字、小数点、空格 "
                },
                "weight": {//10位数字3位小数
                    "regex": /^(0|[1-9][0-9]{0,9}|\d{0,6}\.\d{1,4}|\d{0,7}\.\d{1,3}|\d{0,8}\.\d{1,2}|\d{0,9}\.\d{1})$/,
                    "alertText": "* 输入不正确;不允许超过10位;并且最多4位小数。"
                },
                "fee": {
                    "regex": /^(0|[1-9][0-9]{0,9}|\d{0,7}\.\d{1,3}|\d{0,8}\.\d{1,2}|\d{0,9}\.\d{1})$/,
                    ///^[0,9]{1,6}|(.{1}[0-9]{1,3})|([1-9][0-9])$/,
                    "alertText": "* 输入不正确;不允许超过10位;并且最多3位小数。"
                }, 
                "feemtzero": {
                   "regex": /^(?!0$|0.00$|0.000$|0.0000$)(?:(?!0)\d+|0)(?:\.\d{1,4})?$/,
                  // "regex": /^(?!0$|0.00$)(?:(?!0)\d+|0)(?:\.\d{1,2})?$/,
                    "alertText": "* 输入不正确;不能为0;并且最多4位小数。"
                }, 
                "feemtzero2": {
                   "regex": /^(?!0$|0.0$|0.00$$)(?:(?!0)\d+|0)(?:\.\d{1,2})?$/,
                    "alertText": "* 输入不正确;不能为0;并且最多2位小数。"
                }, 
                "fee2": {
                    "regex": /^(([0-9]+)|([0-9]+\.[0-9]{1,2}))$/,
                    ///^[0,9]{1,6}|(.{1}[0-9]{1,3})|([1-9][0-9])$/,
                    "alertText": "* 非负数 小数点后保留两位。"
                }, 
                "englishchineseOnly": {
                    "regex": /^[a-zA-Z]|[\u4e00-\u9fa5]+$/, //
                    "alertText": "* 要么全部是中文，要么全部是字母。"
                },
                "echineseOnly": {
                    "regex": /^[a-zA-Z\u4e00-\u9fa5]+$/, //
                    "alertText": "* 只能输入中文或者英文。"
                },
                "chineseOnly": {
                    "regex": /^[\u4e00-\u9fa5]+$/,
                    "alertText": "* 只能输入中文。"
		...
		"nochinese":{
		     ...
		     "alertText":"不能输入中文."
                ...
                "englishOnly": {
                    "regex": /^[a-zA-Z]+$/, //只含有汉字、数字、字母、下划线，下划线位置不限：
                    "alertText": "* 只能输入字母。"
                },
                "postcode":
                {
                    "regex": /^[0-9]{0,10}$/,
                    "alertText": "* 邮政不能超过10位数字。"
                },
                "fax":
                {
                "regex":/^[+]{0,1}(\d){1,3}[ ]?([-]?((\d)|[ ]){1,12})+$/,//：+123 -999 999 ； +123-999 999 ；123 999 999 ；+123 999999
                 "alertText": "* 传真号码有误。"
                },
                "cename":{
                  "regex": /^[[a-zA-Z]{1,20}|[\u4e00-\u9fa5]{1,5}]+$/,
                  "alertText": "* 中文长度不超过5位，英文不超过20位。"
                },
                // (@"^(?:[a-zA-Z]{1,10}|[\u4e00-\u9fa5]{6})$");
                //^[a-zA-Z0-9_/u4e00-/u9fa5]+$
                "ajaxIsProductNameExists": {
                    "url": "/Home/Search",
                    "extraData": "name=abc",
                    "alertTextOk": "* 产品名称正确",
                    "alertText": "* 产品名称不存在",
                    "alertTextLoad": "* 正在确认产品名称是否存在，请稍等。"
                },
                "CompanyName": {
                    "regex": /^[a-zA-Z0-9.,，：:\-\s\u4e00-\u9fa5]+$/,
                  "alertText": "* 企业信息中的公司名称不能输入特殊字符！"
                }   ,
                "In_CompanyName": {
                    "regex": /^[a-zA-Z0-9.,，：:\-\s\u4e00-\u9fa5]+$/,
                  "alertText": "* 基本资料中的公司名称不能输入特殊字符！"
                }   ,
                "In_CompanyAddress": {
                    "regex": /^[a-zA-Z0-9.,，：:\-\s\u4e00-\u9fa5]+$/,
                  "alertText": "* 基本资料中的公司地址不能输入特殊字符！"
                }   ,
                "In_UserName": {
                    "regex": /^[a-zA-Z\u4e00-\u9fa5\s]+$/,
                  "alertText": "* 联系人姓名只允许中文，不得为空格！"
                }  ,
                "In_Telephone": {
                    "regex": /^(13[0-9]|15[0|3|6|7|8|9]|18[8|9])\d{8}$/,
                    "alertText": "* 联系手机号码格式不正确"
                },
                "UserName": {
                    "regex": /^[a-zA-Z\u4e00-\u9fa5\s]+$/,
                  "alertText": "* 名字只允许中文，应为，空格！"
                }  ,
                "Telephone": {
                    "regex": /^[0-9]{2,4}\-[0-9]+$/,
                  "alertText": "* 联系电话格式不正确，正确格式如 025-88888888！"
                } ,
                "LoadCountryAutoComplete": { 
                    "regex": /^((?!请输入起运港\[中文\/拼音\/英文\]).)*$/,
                  "alertText": "*此处必填"
                },
                "ArrivalCountryAutoComplete": {
                     "regex": /^((?!请输入目的港\[中文\/拼音\/英文\]).)*$/,
                  "alertText": "*此处必填 "
                },
                "CountryAutoComplete": {
                     "regex": /^((?!国家中文\/拼音\/英文).)*$/,
